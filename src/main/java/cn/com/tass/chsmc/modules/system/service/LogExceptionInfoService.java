...
@Transactional
public interface LogExceptionInfoService extends GenericService<LogExceptionInfo>{
	
	Page<LogExceptionInfo> listLogExceptionInfo(DtPageable dtPageable) throws Exception;
}